...
impl<'a> Analysis<'a> {
    ...
    pub fn disassemble_label<W: core2::io::Write>(
        &self,
        output: &mut W,
    ...
    pub fn disassemble<W: core2::io::Write>(&self, output: &mut W) -> core2::io::Result<()> {
    ...
    pub fn disassemble_trace_log<W: core2::io::Write>(
        &self,
        output: &mut W,
    ...
    pub fn visualize_graphically<W: core2::io::Write>(
        &self,
        output: &mut W,
        ...
        fn emit_cfg_node<W: core2::io::Write>(
            output: &mut W,
            dynamic_analysis: Option<&DynamicAnalysis>,
            analysis: &Analysis,
